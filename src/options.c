...
void option_genre(GtkButton *button, gpointer data, FiltrosBusqueda *filtros){
    ...
    /*Acción*/
    if (gtk_toggle_button_get_activate(GTK_TOGGLE_BUTTON(radio[0]))){
        filtros->genero_id = 28;
    /*Romance*/
    } else if (gtk_toggle_button_get_activate(GTK_TOGGLE_BUTTON(radio[1]))){
        filtros->genero_id = 10746;
    /*Comedia*/
    } else if (gtk_toggle_button_get_activate(GTK_TOGGLE_BUTTON(radio[2]))){
        filtros->genero_id = 35;
    /*Thriller*/
    } else if (gtk_toggle_button_get_activate(GTK_TOGGLE_BUTTON(radio[3]))){
        filtros->genero_id = 53;
    /*Terror*/
    } else if (gtk_toggle_button_get_activate(GTK_TOGGLE_BUTTON(radio[4]))){
        filtros->genero_id = 27;
    /*Drama*/
    } else if (gtk_toggle_button_get_activate(GTK_TOGGLE_BUTTON(radio[5]))){
